...
const About = () => {
  ...
  Education
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { degree: "B.Tech - CSE", years: "2022 – 2026", cgpa: "8.50", school: "PES University" },
              ...
              <div key={i} className="border border-purple-900 bg-black bg-opacity-30 p-4 rounded-lg shadow-md hover:scale-105 transition-transform duration-300">
          ...
          <div className="border-l-2 border-purple-500 pl-6 space-y-8">
            {[
              ...
              <div key={i} className="relative">
                <div className="absolute -left-[1.15rem] top-1 w-3 h-3 bg-[#632b94] rounded-full" />
                <div>
...
<div className="mt-12">
  ...
  <div className="flex flex-wrap gap-4">
    {[
      ...
      <span
        key={i}
        className="bg-gradient-to-r from-purple-800 to-indigo-700 text-white px-4 py-2 text-sm rounded-full shadow-md transform transition-transform hover:scale-105 hover:shadow-lg cursor-default"
      >
        {item.skill}
      </span>
    ))}
...
{/* Languages Known */}
<div className="mt-12">
  <h3 className="text-2xl font-semibold mb-4 text-purple-400">🌐 Languages Known</h3>
  <div className="flex flex-wrap gap-4">
    {[
      { language: "🗣 Kannada (Fluent)" },
