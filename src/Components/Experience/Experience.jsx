...
import sharp from "../../assets/Sharpener.png"
import {
  FaCss3,
  FaFigma,
  FaHtml5,
...
/>
  ...
  <span className="text-white">
    ...
    <p className="text-sm p-2">Worked as a Software Developer Intern at DeepThought (June–July 2024), contributing to React-based development.</p>
  </span>
</div>
