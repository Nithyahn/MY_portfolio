...
const Home = () => {
  ...
  <button
    ...
    className="text-white py-2 px-3 text-sm md:text-lg md:py-2 md:px-4 hover:opacity-85 duration-300 hover:scale-105 font-semibold rounded-3xl bg-purple-800"
  >
    Contact Me
  </button>

  <a
    href="https://drive.google.com/file/d/1n2q7f4fFyR0gD1jWI5F6mYO0UU6YUzZd/view?usp=sharing" // Replace with your actual resume file path or external link
    target="_blank"
